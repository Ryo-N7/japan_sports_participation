...
jpn_sports <- read_xlsx("../data/jpn_sports_participation.xlsx", skip = 14)


jpn_sports_dfaaa <- read_csv("../data/jpn_sports_particip.csv")

jpn_sports_df <- read_xlsx("../data/a078_1.xlsx", skip = 14)
...
jpn_sports_df <- jpn_sports_df %>% 
  select(-`11`, -J, -X__1, -X__2, -X__3, -X__4) %>% 
  slice(-c(1, 2, 3, 4))
...
saveRDS(jpn_sports_total, file = "../data/jpn_sports_total.RDS")
